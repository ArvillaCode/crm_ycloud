...
let mockContacts = [
  { id: 'c_1', name: 'Alejandro Gómez', phone: '+525512345678', email: 'alejandro@gomez.com', company: 'Inversiones Gómez', notes: 'Interesado en departamento de 2 recámaras en Polanco.', pipeline_stage_id: 'stage_1', assigned_user_id: 'u_1', last_message_at: '2026-06-03T18:42:00.000Z' },
  { id: 'c_2', name: 'María Rodríguez', phone: '+34612345678', email: 'maria.r@gmail.com', company: 'Freelance Design', notes: 'Preguntó por costos de soporte premium.', pipeline_stage_id: 'stage_2', assigned_user_id: 'u_2', last_message_at: '2026-06-03T17:15:00.000Z' },
  { id: 'c_3', name: 'Carlos Mendoza', phone: '+5491198765432', email: 'carlos@mendoza.co', company: 'E-commerce Corp', notes: 'Solicitó demo de la plataforma.', pipeline_stage_id: 'stage_1', assigned_user_id: 'u_1', last_message_at: '2026-06-02T12:00:00.000Z' },
  { id: 'c_4', name: 'Laura Martinez', phone: '+56987654321', email: 'laura@martinez.cl', company: 'Minera del Norte', notes: 'Trato cerrado. Pendiente de onboarding.', pipeline_stage_id: 'stage_3', assigned_user_id: 'u_1', last_message_at: '2026-05-30T10:00:00.000Z' }
];
      ...
      mockContacts = mockContacts.map(c => 
        c.id === contactId 
          ? { 
              ...c, 
              ...contactData, 
              // handle field name maps between create format and database row schema
